...
function f6() {
    ...
    document.querySelector('.out-6').innerHTML = i6;
...
function f7() {
    ...
    let out71 = document.querySelector('.out-71').innerHTML = i7;
...
function f11() {
    let i11 = document.querySelector('.i-111').value;
    let i12 = document.querySelector('.i-112');
    i12.value = i11;
}
