...
let e1 = '3';
let f1 = 5;
document.querySelector('.out-4').textContent = (e1 + f1); //тип значения переменной e1 - строка, JS автоматически выполняет конкатенацию, а не матем. операцию - сложение. 
...
function t9() {
    ...
    let inputIn = document.querySelector('.out-9').innerHTML = (data.value);
    data.value = '';
}
...
function t10() {
    ...
    let num = +inputIn.value * 20;
    let data = document.querySelector('.out-10').innerHTML = num;
...
function t11() {
    ...
    let num = inputIn.value + 55;
    let data = document.querySelector('.out-11').innerHTML = num;
}
...
function t12() {
    let inputOne = document.querySelector('.i-12-1');
    let inputTwo = document.querySelector('.i-12-2');

    let data = document.querySelector('.out-12').innerHTML = ('Hello ' + inputOne.value + ' ' + inputTwo.value);
...
function t13() {
    let inputOne = document.querySelector('.i-13-1');
    let inputTwo = document.querySelector('.i-13-2');
...
function t15() {
    let inputIn = document.querySelector('.i-15');
    let borderColor = inputIn.style.border = "4px solid red"
}
...
function t16() {
    let inputOne = document.querySelector('.i-16-1').value;
    let inputTwo = document.querySelector('.i-16-2').value;
    document.querySelector('.out-16').innerHTML = (inputOne + inputTwo);
}
...
function t19() {
    let inputOne = document.querySelector('.i-19-1');
    let inputTwo = document.querySelector('.i-19-2');
    document.querySelector('.out-19').innerHTML = (+inputOne.value + +inputTwo.value);
}
...
function t20() {
    ...
    let a = document.querySelector('.out-20').innerHTML = count++;
