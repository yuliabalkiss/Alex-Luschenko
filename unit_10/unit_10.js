...
let ar2 = ['Yulia', 'Balkis', true, false, 1989, 9];
...
let ar3 = ['Yulia', 'Balkis', true, false, 1989, 9];
...
function f12() {
    ...
    for (let i = 0; i < ar12.length; i++) {
        let indexElement = ar12[0];
        ar12[0] = ar12[ar12.length - 1];
        ar12[ar12.length - 1] = indexElement;
        out += ar12[i] + ' ';
    }
...
function f16() {
    ...
    for (let i = 0; i < ar16_even.length; i++) {
        even_out += ar16_even[i] + ' ';
    }
    document.querySelector('.out-16-odd').innerHTML = odd_out;
    document.querySelector('.out-16-even').innerHTML = even_out;
