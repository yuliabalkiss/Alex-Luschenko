...
function f5() {
    let outOne = document.querySelector('.out-4');
    let outTwo = document.querySelector('.out-5');
    if (outOne.classList.toggle('bg-orange')) {
        outTwo.innerHTML = true;
    } else {
        outTwo.innerHTML = false;
    }
}
...
function f6() {
    let num = document.querySelectorAll('.p-6');
    let out = '';
