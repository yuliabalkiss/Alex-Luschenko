...
function f1() {
   let innerIn = +document.querySelector('.i-1').value;
   if (innerIn == 4) {
...
function f2() {
   let inputIn = +document.querySelector('.out-2');
   if (a21 > a22) {
...
function f7() {
   ...
   let c = a ** b;
   document.querySelector('.out-7').innerHTML = c;
}
...
function f8() {
   let values = +document.querySelector('.s-8').value;
   switch (values) {
      case 1:
...
function f10() {
   let values = +document.querySelector('.s-100').value;
   document.querySelector('.out-10').innerHTML = values;
}
...
function f11() {
   let values = +document.querySelector('.s-110').value;
   document.querySelector('.out-11').innerHTML = values;
}
...
function f12() {
   let v = document.querySelector('.i-120').value;
...
function f13() {
   let inputIn = document.querySelector('.i-130').value;
   document.querySelector('.out-13').innerHTML = (typeof inputIn);
...
function f14() {
   ...
   let inputIn = document.querySelector('.out-14');
   if (v === '+') {
      inputIn.innerHTML = a + b;
   }
   else if (v === '-') {
      inputIn.innerHTML = a - b;
   }
...
function f15() {
   ...
   let v = document.querySelector('.s-153').value;
   let num = document.querySelector('.out-15');
